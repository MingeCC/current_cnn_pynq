...
localparam
    ...
    ADDR_KX_DATA_0          = 7'h20,
    ADDR_KX_CTRL            = 7'h24,
    ADDR_KY_DATA_0          = 7'h28,
    ADDR_KY_CTRL            = 7'h2c,
    ADDR_WIN_DATA_0         = 7'h30,
    ADDR_WIN_CTRL           = 7'h34,
    ADDR_HIN_DATA_0         = 7'h38,
    ADDR_HIN_CTRL           = 7'h3c,
    ADDR_STRIDE_DATA_0      = 7'h40,
    ADDR_STRIDE_CTRL        = 7'h44,
    ADDR_PADDING_DATA_0     = 7'h48,
    ADDR_PADDING_CTRL       = 7'h4c,
    ADDR_FEATURE_IN_DATA_0  = 7'h50,
    ADDR_FEATURE_IN_CTRL    = 7'h54,
    ADDR_WEIGHT_DATA_0      = 7'h58,
    ADDR_WEIGHT_CTRL        = 7'h5c,
    ADDR_FEATURE_OUT_DATA_0 = 7'h60,
    ADDR_FEATURE_OUT_CTRL   = 7'h64,
    ADDR_BIAS_DATA_0        = 7'h68,
