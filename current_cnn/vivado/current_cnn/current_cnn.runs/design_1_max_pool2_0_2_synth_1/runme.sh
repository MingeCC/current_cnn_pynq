...
HD_PWD='F:/Desktop/Vivado_prj/current_pool2D/current_pool2D.runs/design_1_max_pool2_0_2_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_max_pool2_0_2.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_max_pool2_0_2.tcl
