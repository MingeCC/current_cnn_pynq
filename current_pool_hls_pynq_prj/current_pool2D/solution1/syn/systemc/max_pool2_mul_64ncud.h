...
// ==============================================================
#ifndef __max_pool2_mul_64ncud__HH__
#define __max_pool2_mul_64ncud__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(max_pool2_mul_64ncud) {
    ...
    SC_CTOR(max_pool2_mul_64ncud):  ACMP_mul_uu_U ("ACMP_mul_uu_U") {
