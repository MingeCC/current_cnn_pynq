...
entity max_pool2_AXILiteS_s_axi is
generic (
...
end entity max_pool2_AXILiteS_s_axi;
...
architecture behave of max_pool2_AXILiteS_s_axi is
    ...
    constant ADDR_CH_IN_DATA_0 : INTEGER := 16#20#;
    constant ADDR_CH_IN_CTRL   : INTEGER := 16#24#;
    constant ADDR_IN_R_DATA_0  : INTEGER := 16#28#;
    constant ADDR_IN_R_CTRL    : INTEGER := 16#2c#;
