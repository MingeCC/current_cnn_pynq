...
// ==============================================================
#ifndef __max_pool2_fcmp_32bkb__HH__
#define __max_pool2_fcmp_32bkb__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(max_pool2_fcmp_32bkb) {
    ...
    SC_CTOR(max_pool2_fcmp_32bkb):  ACMP_fcmp_comb_U ("ACMP_fcmp_comb_U") {
