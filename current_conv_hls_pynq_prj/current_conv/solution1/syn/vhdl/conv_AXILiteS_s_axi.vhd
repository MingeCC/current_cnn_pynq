...
architecture behave of conv_AXILiteS_s_axi is
    ...
    constant ADDR_KX_DATA_0          : INTEGER := 16#20#;
    constant ADDR_KX_CTRL            : INTEGER := 16#24#;
    constant ADDR_KY_DATA_0          : INTEGER := 16#28#;
    constant ADDR_KY_CTRL            : INTEGER := 16#2c#;
    constant ADDR_WIN_DATA_0         : INTEGER := 16#30#;
    constant ADDR_WIN_CTRL           : INTEGER := 16#34#;
    constant ADDR_HIN_DATA_0         : INTEGER := 16#38#;
    constant ADDR_HIN_CTRL           : INTEGER := 16#3c#;
    ...
    constant ADDR_WEIGHT_DATA_0      : INTEGER := 16#58#;
    constant ADDR_WEIGHT_CTRL        : INTEGER := 16#5c#;
    constant ADDR_FEATURE_OUT_DATA_0 : INTEGER := 16#60#;
    constant ADDR_FEATURE_OUT_CTRL   : INTEGER := 16#64#;
    constant ADDR_BIAS_DATA_0        : INTEGER := 16#68#;
