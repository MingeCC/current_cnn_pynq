...
set Interfaces {
    s_axi_AXILiteS {
        ...
        registers {{0x00 CTRL       RW   0x0 "Control signals" {{ 0 1 AP_START RW 0 "Control signal Register for 'ap_start'." } { 1 1 AP_DONE R 0 "Control signal Register for 'ap_done'." } { 2 1 AP_IDLE R 0 "Control signal Register for 'ap_idle'." } { 3 1 AP_READY R 0 "Control signal Register for 'ap_ready'." } { 4 3 RESERVED_1 R 0 "Reserved.  0s on read." } { 7 1 AUTO_RESTART RW 0 "Control signal Register for 'auto_restart'." } { 8 24 RESERVED_2 R 0 "Reserved.  0s on read." }}} {0x04 GIER       RW   0x0 "Global Interrupt Enable Register" {{ 0 1 Enable RW 0 "Master enable for the device interrupt output to the system interrupt controller: 0 = Disabled, 1 = Enabled" } { 1 31 RESERVED R 0 "Reserved.  0s on read." }} } {0x08 IP_IER     RW   0x0 "IP Interrupt Enable Register" {{ 0 1 CHAN0_INT_EN RW 0 "Enable Channel 0 (ap_done) Interrupt.  0 = Disabled, 1 = Enabled." } { 1 1 CHAN1_INT_EN RW 0 "Enable Channel 1 (ap_ready) Interrupt.  0 = Disabled, 1 = Enabled." } { 2 30 RESERVED R 0 "Reserved.  0s on read." }}} {0x0c IP_ISR     RW   0x0 "IP Interrupt Status Register" {{ 0 1 CHAN0_INT_ST RTOW 0 "Channel 0 (ap_done) Interrupt Status. 0 = No Channel 0 input interrupt, 1 = Channel 0 input interrup" } { 1 1 CHAN1_INT_ST RTOW 0 "Channel 1 (ap_ready) Interrupt Status. 0 = No Channel 1 input interrupt, 1 = Channel 1 input interrup" } { 2 30 RESERVED R 0 "Reserved.  0s on read." }}} {0x10 chin W 0x0 "Data signal of chin" {{0 32 chin W 0 "Bit 31 to 0 Data signal of chin"}}} {0x18 chout W 0x0 "Data signal of chout" {{0 32 chout W 0 "Bit 31 to 0 Data signal of chout"}}} {0x20 kx W 0x0 "Data signal of kx" {{0 32 kx W 0 "Bit 31 to 0 Data signal of kx"}}} {0x28 ky W 0x0 "Data signal of ky" {{0 32 ky W 0 "Bit 31 to 0 Data signal of ky"}}} {0x30 win W 0x0 "Data signal of win" {{0 32 win W 0 "Bit 31 to 0 Data signal of win"}}} {0x38 hin W 0x0 "Data signal of hin" {{0 32 hin W 0 "Bit 31 to 0 Data signal of hin"}}} {0x40 stride W 0x0 "Data signal of stride" {{0 32 stride W 0 "Bit 31 to 0 Data signal of stride"}}} {0x48 padding W 0x0 "Data signal of padding" {{0 32 padding W 0 "Bit 31 to 0 Data signal of padding"}}} {0x50 feature_in W 0x0 "Data signal of feature_in" {{0 32 feature_in W 0 "Bit 31 to 0 Data signal of feature_in"}}} {0x58 weight W 0x0 "Data signal of weight" {{0 32 weight W 0 "Bit 31 to 0 Data signal of weight"}}} {0x60 feature_out W 0x0 "Data signal of feature_out" {{0 32 feature_out W 0 "Bit 31 to 0 Data signal of feature_out"}}} {0x68 bias W 0x0 "Data signal of bias" {{0 32 bias W 0 "Bit 31 to 0 Data signal of bias"}}}}
        memories ""
        ctype {
            AWVALID {
                Type "bool"
...
## System Info
set user_parameters_list {clk_period 50 machine 64 combinational 0 latency 77906 II x}
