...
reg   [0:0] tmp_s_reg_192;
reg   [30:0] c_reg_112;
reg   [30:0] c_reg_112_pp0_iter1_reg;
wire    ap_block_state9_pp0_stage0_iter0;
reg    ap_block_state10_pp0_stage0_iter1;
wire    ap_block_state11_pp0_stage0_iter2;
reg    ap_block_pp0_stage0_11001;
wire   [31:0] n_fu_130_p2;
reg   [31:0] n_reg_180;
reg   [31:0] weight_addr_reg_186;
wire   [0:0] tmp_s_fu_164_p2;
reg   [0:0] tmp_s_reg_192_pp0_iter1_reg;
wire   [30:0] c_1_fu_169_p2;
reg   [30:0] c_1_reg_196;
reg    ap_enable_reg_pp0_iter0;
reg   [31:0] weight_addr_read_reg_201;
wire    ap_CS_fsm_state8;
reg    ap_block_pp0_stage0_subdone;
reg    ap_condition_pp0_exit_iter0_state9;
reg    ap_enable_reg_pp0_iter2;
reg   [30:0] ap_phi_mux_c_phi_fu_116_p4;
wire   [63:0] tmp_12_fu_175_p1;
wire  signed [63:0] sum2_cast_fu_150_p1;
reg    ap_reg_ioackin_m_axi_weight_ARREADY;
reg    ap_sig_ioackin_m_axi_weight_ARREADY;
wire  signed [31:0] tmp1_fu_124_p0;
wire  signed [31:0] tmp1_fu_124_p1;
wire  signed [31:0] n_fu_130_p0;
wire  signed [31:0] tmp1_fu_124_p2;
wire  signed [32:0] tmp_3_cast_fu_136_p1;
wire   [32:0] sext_cast_fu_140_p1;
wire   [32:0] sum2_fu_144_p2;
wire   [31:0] c_cast_fu_160_p1;
...
always @ (posedge ap_clk) begin
    if (((ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (1'b0 == ap_block_pp0_stage0_11001) & (tmp_s_reg_192 == 1'd1))) begin
...
always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_state1) & (ap_start == 1'b1))) begin
        ...
        weight_addr_reg_186 <= sum2_cast_fu_150_p1;
    end
end

always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_pp0_stage0) & (1'b0 == ap_block_pp0_stage0_11001) & (tmp_s_reg_192 == 1'd1))) begin
        weight_addr_read_reg_201 <= m_axi_weight_RDATA;
    end
end

always @ (*) begin
    if ((tmp_s_fu_164_p2 == 1'd0)) begin
...
always @ (*) begin
    if (((ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (tmp_s_reg_192 == 1'd1) & (1'b0 == ap_block_pp0_stage0))) begin
...
always @ (*) begin
    if (((ap_enable_reg_pp0_iter2 == 1'b1) & (1'b0 == ap_block_pp0_stage0_11001) & (tmp_s_reg_192_pp0_iter1_reg == 1'd1))) begin
...
always @ (*) begin
    case (ap_CS_fsm)
        ...
        ap_ST_fsm_pp0_stage0 : begin
            if ((~((tmp_s_fu_164_p2 == 1'd0) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter1 == 1'b0)) & ~((ap_enable_reg_pp0_iter2 == 1'b1) & (1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter1 == 1'b0)))) begin
                ap_NS_fsm = ap_ST_fsm_pp0_stage0;
            end else if ((((ap_enable_reg_pp0_iter2 == 1'b1) & (1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter1 == 1'b0)) | ((tmp_s_fu_164_p2 == 1'd0) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter1 == 1'b0)))) begin
...
always @ (*) begin
    ap_block_pp0_stage0_11001 = ((m_axi_weight_RVALID == 1'b0) & (ap_enable_reg_pp0_iter1 == 1'b1) & (tmp_s_reg_192 == 1'd1));
end

always @ (*) begin
    ap_block_pp0_stage0_subdone = ((m_axi_weight_RVALID == 1'b0) & (ap_enable_reg_pp0_iter1 == 1'b1) & (tmp_s_reg_192 == 1'd1));
end

always @ (*) begin
    ap_block_state10_pp0_stage0_iter1 = ((m_axi_weight_RVALID == 1'b0) & (tmp_s_reg_192 == 1'd1));
end
...
assign c_1_fu_169_p2 = (ap_phi_mux_c_phi_fu_116_p4 + 31'd1);

assign c_cast_fu_160_p1 = ap_phi_mux_c_phi_fu_116_p4;

assign m_axi_weight_ARADDR = weight_addr_reg_186;
...
assign m_axi_weight_ARLEN = n_reg_180;
...
assign n_fu_130_p0 = kx;

assign n_fu_130_p2 = ($signed(n_fu_130_p0) * $signed(tmp1_fu_124_p2));

assign sext_cast_fu_140_p1 = weight_offset;

assign sum2_cast_fu_150_p1 = $signed(sum2_fu_144_p2);

assign sum2_fu_144_p2 = ($signed(tmp_3_cast_fu_136_p1) + $signed(sext_cast_fu_140_p1));

assign tmp1_fu_124_p0 = chin;

assign tmp1_fu_124_p1 = ky;

assign tmp1_fu_124_p2 = ($signed(tmp1_fu_124_p0) * $signed(tmp1_fu_124_p1));

assign tmp_12_fu_175_p1 = c_reg_112_pp0_iter1_reg;

assign tmp_3_cast_fu_136_p1 = $signed(weight_offset1);

assign tmp_s_fu_164_p2 = (($signed(c_cast_fu_160_p1) < $signed(n_reg_180)) ? 1'b1 : 1'b0);

assign weight_buffer_address0 = tmp_12_fu_175_p1;

assign weight_buffer_d0 = weight_addr_read_reg_201;
